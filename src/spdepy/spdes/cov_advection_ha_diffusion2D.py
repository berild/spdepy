...
class CovAdvectionHaDiffusion2D:
    ...
    def print(self,par):
        return("| \u03BA = %2.2f"%(np.exp(par[0])) +  ", \u03B3 = %2.2f"%(np.exp(par[1])) + ", vx = %2.2f"%(par[2])+ ", vy = %2.2f"%(par[3])+ ", \u039B = %2.2f"%(np.exp(par[4])) +", \u03C3 = %2.2f"%(np.exp(par[5])) +  ", \u03C4 = %2.2f"%(np.exp(par[6])))
